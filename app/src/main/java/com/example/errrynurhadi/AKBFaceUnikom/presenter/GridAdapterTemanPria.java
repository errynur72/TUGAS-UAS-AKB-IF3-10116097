...
public class GridAdapterTemanPria extends RecyclerView.Adapter<GridAdapterTemanPria.ViewHolder> implements Filterable {

    ArrayList<Item> mItems, filterlist;
    Context context;

    public GridAdapterTemanPria(Context context, ArrayList<Item> mItems) {
