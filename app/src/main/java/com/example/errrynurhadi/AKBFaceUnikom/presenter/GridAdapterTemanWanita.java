...
public class GridAdapterTemanWanita extends RecyclerView.Adapter<GridAdapterTemanWanita.ViewHolder> implements Filterable {

    ArrayList<Item> mItems, filterlist;
    Context context;

    public GridAdapterTemanWanita(Context context, ArrayList<Item> mItems) {
